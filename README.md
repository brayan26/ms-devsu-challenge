...
## Getting started
SpringBoot application using JDK 17 for the Devsu LLC company challenge, on CRUD operations of the bank transactions
...
```
datasource: jdbc:mysql://localhost:3306/test
username: root
password: 1122q!
```

## Postman
import the ./devsu-llc.postman_collection.json file to your postman application
